...
import { useUpdateExpense } from '@/app/(auth)/hooks/mutations'
...
interface DialogUpdateExpenseFormProps extends Expense {}

export function DialogUpdateExpenseForm(props: DialogUpdateExpenseFormProps) {
  ...
  function handleUpdateExpense(data: UpdateFormSchemaInput) {
    mutate(
      {
        params: {
          id: props.id,
